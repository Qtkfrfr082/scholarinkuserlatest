      ...
      <div className="signup-form-container">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="input-group">
            <button
              type="button"
              className="bg-white text-gray-500 relative w-full shadow-sm pl-3 pr-10 py-3 text-left cursor-pointer focus:outline-none focus:ring-1 rounded-full sm:text-sm hover:border-emerald-600 p-3 border border-gray-300 text-base transition-all duration-200 bg-transparent"
